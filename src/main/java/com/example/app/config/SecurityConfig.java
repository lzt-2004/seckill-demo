    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/products/cancel/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/seckill/**").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/seckill/orders/**").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/seckill/pay/**").authenticated()
